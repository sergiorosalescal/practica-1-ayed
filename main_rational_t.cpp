...
// Según la Guía de estilo de Google, estos deben aparecer ordenados
// alfabeticamente, y en primer lugar los .h correspondientes
...
int main()
{
  rational_t a(3, 2), b(1,3), c; // Declaracion de los objetos de la clase "rational_t"
